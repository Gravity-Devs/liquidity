...
func (AppModule) ProposalContents(simState module.SimulationState) []simtypes.WeightedProposalContent { //nolint:staticcheck // this is needed to satisfy the module interface
	return nil
}
